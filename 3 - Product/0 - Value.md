...
# Re:place Product
LifeWeb is a means for agents to participate in cultivating knowledge and learning by progressing through 12 orders of relating in an emerging autonomous ecosystem. What does that [[Framework Intro|mean]]?
### Personal Librarian
...
### Digital Identity
The accounting of a person inhabiting such a space was deduced as a strong place to start developing this infrastructure since this component will likely be consistently required going forwards. As such the development of a LifeWeb digital identity is one of the next steps on the roadmap and is expected to have immediate utility to community hubs.
# Re:place + Voyaging
