...
| Discerning Search Param               | Traditional Search                        | Schema-Based Search                                                |
| ------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------ |
| **User-Defined Perspectives**         | Predefined algorithms and categories      | User-defined schemas and perspectives                              |
...
| **Holistic Perspective Construction** | Based on keyword matches and algorithms   | Integrates diverse sources and maps relationships between concepts |

**Maintaining Context:** Unlike the prevailing search paradigm that matches user-entered keywords to index pages and ranks de-contextualised results based on 3rd party interests, the schema-based librarian leverages contextual information and searches based on semantic meaning. 
